...
| الدردشة | مجموعة الإدارة كاملة (ردود، تفاعلات، تثبيت، قفل، حضور، «يكتب…»، ✓✓، بحث، حذف عندي/عند الجميع) + المحادثات الفرديّة + «ردّ بشكل خاص» + حذف المحادثة الخاصّة بكامل محتواها عند الطرفين |
...
| اللوحة | بطاقات الإجراءات مجمّعة بحسب العمل (خمس بطاقات) وكلّ وجهة باقية سطراً داخل بطاقة أهلها؛ بطاقات الإحصائيات و«مهامّي اليوم» كما هي |
